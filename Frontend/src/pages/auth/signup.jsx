...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-[#0F3D3E] flex items-center justify-center px-4">
      <div className="w-full max-w-6xl bg-transparent">
        <div className="flex flex-col md:flex-row min-h-[85vh] rounded-lg overflow-hidden">
          {/* LEFT PANEL */}
          <div className="md:w-1/2 w-full bg-[#2C8F99] flex flex-col items-center justify-center text-white p-10">
            <img src={Logo} alt="School Logo" className="w-28 mb-6" />
            <h1 className="text-5xl font-bold tracking-wide">WELCOME</h1>
          </div>

          {/* RIGHT PANEL */}
          <div className="md:w-1/2 w-full bg-[#050D3D] flex items-center justify-center relative p-6">
            {/* CLOSE */}
            <button
              onClick={() => navigate("/")}
            ...
            <div className="bg-white w-full max-w-sm rounded-xl shadow-2xl p-8">
              ...
              {/* REGISTER BUTTON */}
              <button
                className="w-full py-3 border-2 border-blue-600 text-blue-600 font-semibold rounded-lg
